<header class="topbar relative z-40">
    ...
    <div class="ml-auto hidden items-center gap-3 xl:flex">
        ...
        <div class="hidden items-center gap-2 rounded-full border border-[var(--visitx-border)] bg-[var(--visitx-panel)] px-3 py-2 text-sm font-medium text-[var(--visitx-muted)] shadow-sm 2xl:flex"><svg class="h-4 w-4 text-[var(--visitx-primary)]" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7m0 9.5A2.5 2.5 0 1 1 12 6a2.5 2.5 0 0 1 0 5.5"/></svg>Siege ANAM</div>
        <div x-data="{ dropdownOpen: false }" class="relative">
            <button @click="dropdownOpen = ! dropdownOpen" class="visitx-avatar-circle">{{ strtoupper(substr(Auth::guard('web')->user()->lastname ?? 'U', 0, 1)) }}</button>
